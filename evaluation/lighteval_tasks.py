...
def hmmt_brumo_prompt_fn(line, task_name: str = None):
    return Doc(
        task_name=task_name,
        query=MATH_QUERY_TEMPLATE.format(Question=line["problem"]),
        choices=[line["answer_boxed"]],
        gold_index=0,
    )
...
hmmt_feb_2025 = LightevalTaskConfig(
    name="hmmt_feb_2025",
    suite=["custom"],
    prompt_function=hmmt_brumo_prompt_fn,
    hf_repo="QizhiPei/hmmt_feb_2025",
    hf_subset="default",
    hf_avail_splits=["train"],
    evaluation_splits=["train"],
    few_shots_split=None,
...
brumo_2025 = LightevalTaskConfig(
    name="brumo_2025",
    suite=["custom"],
    prompt_function=hmmt_brumo_prompt_fn,
    hf_repo="QizhiPei/brumo_2025",
    hf_subset="default",
    hf_avail_splits=["train"],
    evaluation_splits=["train"],
    few_shots_split=None,
...
TASKS_TABLE.append(hmmt_feb_2025)
TASKS_TABLE.append(brumo_2025)
